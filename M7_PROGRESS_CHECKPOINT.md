...
- Exact next task: inspect CI for commits through `59d33d3e`. If green, update DEVELOPMENT_STATUS.md and mark M7 complete before moving to M8. If CI exposes a failure, fix only the exact newly exposed issue.
