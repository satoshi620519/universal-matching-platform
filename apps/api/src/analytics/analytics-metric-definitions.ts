...
export const analyticsMetricDefinitions: readonly MetricDefinition[] = [
  ...
  { name: 'moderation_reports', version: 1, scope: 'safety', calculation: 'Count authoritative safety reports by target type; do not duplicate raw report evidence into analytics events.', supportedPeriods: ['day','week','month','quarter','year'], sourceEvents: [] },
