...
type AnalyticsEventMetadata = Omit<AnalyticsEventRecord, 'payload'>;
...
export class AnalyticsEventQueryService {
  ...
  async listRecent(accountId: string, limit = 100, now = new Date()): Promise<readonly AnalyticsEventMetadata[]> {
