  ...
  return (
    <div className="landing">
      <header className="landingNav">
        ...
        <nav aria-label="Preview navigation"><span>Experience</span><span>Safety</span><span>Global</span></nav>
      ...
      <main>
        <section className="heroLanding">
          ...
          <div className="heroCopy">
            ...
            <div className="heroActions"><button className="primaryButton" type="button">Discover the experience <span>↗</span></button><span className="heroNote">A premium foundation for your next service</span></div>
          </div>
        ...
        <section className="ctaLanding"><p className="overline">A NEW STARTING POINT</p><h2>Start with a<br /><em>better foundation.</em></h2><button className="primaryButton light" type="button">Discover what’s possible <span>↗</span></button></section>
      </main>
